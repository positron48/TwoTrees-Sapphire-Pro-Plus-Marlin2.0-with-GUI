# About this Fork
This repository was dropped in favour of [this Repo](https://github.com/RolfZuckowskiUltras/TwoTrees_Sapphire_RawMarlin). The newer repo is directly forked from marlin and should be easier to maintain. Furthermore, features like bed levling are working like a charm out of the box. The newer Repo dropped the LVGL-Gui in favour of the more raw stock marlin 2.0 color touch UI. This Menu is just a lot snappier and less bugging around. I mean: Imagine your printer stopping, while a new menu screen is beeing loaded... I think you get it.
